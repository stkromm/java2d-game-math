...
/**
 * Represents a mathematical immutable vector 2d. You may use MutableVec2f or derive your own vector
 * to create a mutable version of Vec2f.
 *
 * @author Steffen
 *
 */
public class Vec2f implements Serializable
{
	...
	/**
	 * Invalidates cached calculations and recalculates them, if they are requested. (length of the
	 * vector).
	 *
	 */
	 ...
	 *
	 * @param vector
	 *            The vector, that is used to calculate a dot product with this vector.
	 *
	 * @return The dot product of this vector and the given.
	 *
	 */
	public final float dot(final Vec2f vector) throws NullPointerException
	{
		return VectorUtils.dot(x, y, vector.x, vector.y);
	}
	...
	public final float length()
	{
		...
		{
			cachedLength = VectorUtils.length(x, y);
		}
		return cachedLength;
	}
	...
	/**
	 * Returns the squared distance from the point defined by this Vec2f to the point defined by the
	 * given Vec2f.
	 *
	 * @param vector
	 ...
	 */
	public final float squaredDistance(final Vec2f vector) throws NullPointerException
	{
		return squaredDistance(vector.x, vector.y);
	}

	/**
	 * Returns the squared distance from the point defined by the each element given vector and this
	 * vector.
	 *
	...
	/**
	 * Returns the distance from the point defined by this Vec2f to the point defined by the given
	 * Vec2f.
	 *
	 * @param vector
	 *            Point to which the distance is calculated
	 * @return The distance to the given point or Float.MAX_VALUE if distance could not be
	 *         calculated.
	 */
	public final float distance(final Vec2f vector) throws NullPointerException
	{
		return distance(vector.x, vector.y);
	}

	/**
	 * Returns the distance from the point defined by the each element given vector and this vector.
	 *
	 ...
	 */
	public final float getAngle(final Vec2f vector) throws NullPointerException
	{
	...
	/**
	 * Calculates the slope of this vector, if interpreted as a direction in space.
	 *
	...
	/**
	 * Returns true, if the given vector is equal to this vector (with error tolerance).
	 *
	 * @param vector
	 *            The vector, that is checked if it is equal to this vector
	 * @return True, if the vectors are equal with respect to numerical inaccuracies.
	 *
