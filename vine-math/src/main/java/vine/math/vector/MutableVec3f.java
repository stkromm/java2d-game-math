...
public class MutableVec3f extends Vec3f
{
	 ...
	 *
	 * @param vector
	 *            The vector, which elements are added to the corresponding elements of this vector.
	 */
	...
	public void normalize()
	{
		...
		final float inversedLength = 1 / GMath.sqrt(dot(this));
		scale(inversedLength);
		calculatedLength = 1;
	}

	/**
	 * Updates the values of this Vec3f to be the cross product of this vector and the given.
	 */
