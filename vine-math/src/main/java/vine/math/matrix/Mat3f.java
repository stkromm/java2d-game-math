...
public class Mat3f implements Serializable
{
	...
	/**
	 * Maximum difference two floating point values can differ and still count as equal.
	 */
	...
	public Mat3f(final float[] values)
	{
		if (values == null || values.length != 9)
		{
			throw new IllegalArgumentException(
					"Tried to construct Mat3f from an invalid value array");
		}
		a11 = values[0];
		a12 = values[1];
		a13 = values[2];
	...
	/**
	 * Creates a matrix with each element corresponding set to the given parameters.
	 */
	public Mat3f(
			final float a11,
			final float a12,
	...
	{
		return a11 * a22 * a33 + a12 * a23 * a31 + a13 * a21 * a32 - a12 * a21 * a33
				- a13 * a22 * a13 - a11 * a23 * a32;
	}
	...
	public final boolean equals(final Object object)
	{
		...
		final boolean isFirstRowCorrect = GMath
				.abs(a11 - matrix.a11 + a12 - matrix.a12 + a13 - matrix.a13) <= 3 * EPSILON;
		final boolean isSecondRowCorrect = GMath
				.abs(a21 - matrix.a21 + a22 - matrix.a22 + a23 - matrix.a23) <= 3 * EPSILON;
		final boolean isThirdRowCorrect = GMath
				.abs(a31 - matrix.a31 + a32 - matrix.a32 + a33 - matrix.a33) <= 3 * EPSILON;
