...
public class MutableMat3f extends Mat3f implements Transformable
{
	...
	/**
	 * Transforms this matrix into its inversed matrix. Does nothin, if the matrix is not
	 * invertable.
	 */
	...
	/**
	 * Multiplies the given matrix from the left with this Matrix3f. The result is the given matrix.
	 *
	 * @param matrix
	 *            Matrix which is multiplied with this matrix.
	 *
	...
	/**
	 * Scales the scale part of the transformation of this matrix by the given scale vector.
	 *
	 * @param x
	...
	/**
	 * Adds the vector given by the two values as an translation. That is adds the x to the a13
	 * element and the y to the a23 element.
	 *
	 * @param x
