...
public final class Interpolation
{
     ...
     * given lerp value {@code alpha}, which must be in the interval [0,1].
     *
     * @param a
     *            The 1st value
     * @param b
     *            The 2nd value
     * @param alpha
     *            Value used to interpolate between {@code a} and {@code b}. A
     *            value of 0 will result in returning the value {@code a}, a
     *            value of 1 will result in returning the value {@code b}.
     ...
     * @return
     */
    public static float cubic(final float a, final float b, final float t1, final float t2, final float alpha)
    {
     ...
     *
     * Interpolates between the values {@code a} and {@code b} with a circular
     * out function and a circular in function merged at alpha = 0.5 with the
     ...
     * @return The circular inout interpolation of {@code a} and {@code b}
     *         evaluated with {@code alpha}
     */
    ...
    {
        return alpha < 0.5f ? expoIn(a, b, alpha * 2.f) * 0.5f : expoOut(a, b, alpha * 2.f - 1.f) * 0.5f + 0.5f;
    }
     ...
     *         evaluated with {@code alpha}
     */
    public static float circularInOut(final float a, final float b, final float exp, final float alpha)
    {
        return alpha < 0.5f ? circularIn(a, b, alpha * 2.f) * 0.5f : circularOut(a, b, alpha * 2.f - 1.f) * 0.5f + 0.5f;
    }

    /**
     * Interpolates between the values {@code a} and {@code b} with a sin out
     * function and a sin in function merged at alpha = 0.5 with the given lerp
     * value {@code alpha}, which has to be in the interval [0,1].
     *
     * @param a
     *            The 1st value
     * @param b
     ...
     * @param alpha
     *            Value used to interpolate between {@code a} and {@code b}.
     * @return The sin out interpolation of {@code a} and {@code b} evaluated
     *         with {@code alpha}
     */
    public static float sinInOut(final float a, final float b, final float exp, final float alpha)
    {
        return alpha < 0.5f ? sinIn(a, b, alpha * 2.f) * 0.5f : sinOut(a, b, alpha * 2.f - 1.f) * 0.5f + 0.5f;
    }

    /**
     * Interpolates between the values {@code a} and {@code b} with a sin in
     * function with the given lerp value {@code alpha}, which has to be in the
     * interval [0,1].
     *
     * @param a
     *            The 1st value
     ...
     * @param alpha
     *            Value used to interpolate between {@code a} and {@code b}.
     * @return The sin in interpolation of {@code a} and {@code b} evaluated
     *         with {@code alpha}
     */
