...
public class Matrix3fTest
{
	...
	/**
	 * A correctly transposed , orthogonal Matrix multiplied with the not transposed Matrix creates
	 * the identity matrix.
	 */
	@Test
	...
	/**
	 * Tests, that the calculation of the determinant of given matrices is correct.
	 */
	@Test
